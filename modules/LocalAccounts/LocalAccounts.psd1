@{
	...
	ModuleToProcess = 'LocalAccounts.dll'

	# Version number of this module.
	ModuleVersion = '2.1'

	# ID used to uniquely identify this module
	GUID = 'f2f78282-a52f-4944-bed6-0eca65b18465'
	...
	Description = 'Windows PowerShell Module for managing local users and groups'
	...
	TypesToProcess = @('LocalAccounts.types.ps1xml')

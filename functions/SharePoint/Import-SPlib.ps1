...
.EXAMPLE
	Import-SPlib -SiteUrl "http://sharepoint.vbl.ch/Projekte/SitePages/Homepage.aspx" -Path "C:\temp\SharePointExport\Library Projektvorlagen 2013-04-26 11-15-26.cmp"
#>
...
$Metadata = @{
	Title = "Import SharePoint library"
	Filename = "Import-SPlib.ps1"
	Description = ""

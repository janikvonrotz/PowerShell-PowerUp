...
.EXAMPLE
	Export-SPlist -SiteUrl "http://sharepoint.vbl.ch/Projekte/SitePages/Homepage.aspx" -Lists "Projektverwaltung" -Path "C:\temp\SharePointExport"
#>
...
'@
	...
	foreach($List in $Lists){
		...
		Write-Output ($Path + "\List " + $List + $SPFileExtension)
